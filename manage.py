...
``python3 -m pythonproquickly <COMMAND>``, in a straight forward fashion just after
a ``pip3 install``.
...
# (redundant in the case the developer uses `pip install -e .`)
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "src"))


if __name__ == "__main__":
    from pythonproquickly.__main__ import main
